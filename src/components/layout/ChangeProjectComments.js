...
const ChangeProjectComments = () => {
  ...
  // console.log("newProjectDataItem for comments: ", changerequestDataItem);
  const projectId= changerequestDataItem.id;
  const projectType= "ChangeRequest";
  const formData = {
    projectId,
    projectType
  }
...
export default ChangeProjectComments;