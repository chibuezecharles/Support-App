...
const SupportProjectComments = () => {
  ...
  // console.log("newProjectDataItem for comments: ", supportProjectDataItem);
  const projectId= supportProjectDataItem.id;
  const projectType= "ProjectSupport";
  const formData = {
    projectId,
    projectType
  }
...
export default SupportProjectComments;